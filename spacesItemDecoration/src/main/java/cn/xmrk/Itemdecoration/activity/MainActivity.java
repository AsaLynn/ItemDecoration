...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void initView() {
        ...
        Button btn_grid_v3 = (Button) findViewById(R.id.btn_grid_v3);
        ...
        btn_grid_v3.setOnClickListener(this);
    }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.btn_grid_v:
                ...
                break;
            case R.id.btn_grid_v3:
                RecyclerViewActivity.startRecyclerViewActivity(this, RecyclerViewActivity.GRID_VERTICAL3);
                break;
